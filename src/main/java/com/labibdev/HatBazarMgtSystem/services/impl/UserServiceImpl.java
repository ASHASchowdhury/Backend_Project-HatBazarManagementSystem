...
import com.labibdev.HatBazarMgtSystem.exceptions.InvalidCredentialsException;
...
import com.labibdev.HatBazarMgtSystem.security.JwtUtils;
...
public class UserServiceImpl implements UserService {
    ...
    public Response deleteUser(Long id) {
        ...
        return Response.builder()
                .status(200)
                .message("User Succeseefully Deleted")
                .build();
    }
